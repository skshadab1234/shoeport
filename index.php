...
<head>
<title>SHOEPORT- ONLINE SHOPPING Portal</title>
...
<h2 class="mens" id="shop" style="margin-top: 100px" align="center" >shop on SHOEPORT</h2>
...
<div class="swiper-wrapper">
	...
	echo " 
	<div class=\"swiper-slide\"><a href=\"category.php?category=".$row['cat_slug']."\"><img src=\"".$row['cat_img']."\" width=\"150px\" style=\"border-radius: 50%\"></a>
	<h2 style=\"font-size: 18px\"><a class=\"cat\" href=\"\" >".$row['name']."</a></h2></div>
